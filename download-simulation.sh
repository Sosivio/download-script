...
requiredTarSpace=4                # Disk space needed on the computer from which script is ran
requiredImageSpace=4              # Disk space needed for pulling the docker images
directoryName="SimulationsImages" # Directory where the docker images will be saved
OS="`uname`"                      # This determines the type of Operating System

function Usage() {
    echo "Sosivio-simulations-script manual:

Usage: sosivio-simulations-script --pull|--push [OPTIONS]
