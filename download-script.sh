...
version="release-1.2"
microServices=("analyzer" "authentication" "actuator" "classifier" "crud-manager" "contract-testing" "communicator" "sosivio-node-collector" "correlation-entities" "ruleengine" "draingo" "nsqd" "nsqadmin" "nsqlookupd" "sosivio-dashboard" "sequence-detection" "sequence-analysis" "sosiviodb")
